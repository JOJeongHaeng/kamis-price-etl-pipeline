...
class ApiTransformTests(unittest.TestCase):
    def test_normalize_kamis_prices_maps_official_fields(self):
        ...
        self.assertEqual(result.loc[0, "week_before_price"], 3100)
        self.assertEqual(result.loc[0, "year_before_kg_price"], 2700)
        self.assertEqual(result.loc[0, "source_name"], "PUBLIC_DATA_KAMIS")
    ...
    def test_normalize_deduplicates_by_full_product_identity(self):
        ...
        self.assertEqual(result.loc[0, "price_date"], "2026-08-21")
